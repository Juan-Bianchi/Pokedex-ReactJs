...
const Card = () => {
  ...
  return (
    <div className="w-[310px] flex justify-center">
        <div className="overflow-hidden duration-500 hover:duration-500 hover:rotate-12 flex flex-col justify-center items-center h-64 w-[90%] bg-red-600 bg-opacity-50 rounded-2xl outline outline-slate-400 -outline-offset-8 p-1">
          <div className="w-[50%]">
